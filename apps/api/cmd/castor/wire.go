...
func InitServer() (*server.Server, error) {
	wire.Build(
		...
		provideAssetPolicy,
		provideAssetSweepPolicy,
		provideRsaKeyConfig,
		provideKeyring,
		provideSSOPolicy,
		provideNotificationMailPolicy,
		...
		persistence.NewMFARepository,
		persistence.NewSSORepository,
		persistence.NewNotificationEmailRepository,
		// setting repository
		...
		service.NewJobCatalog,
		service.NewJobService,
		service.NewMFAService,
		service.NewSSOService,
		service.NewNotificationStream,
		service.NewNotificationEmailService,
		...
		handler.NewAdminSessionHandler,
		handler.NewAdminDepartmentHandler,
		...
		handler.NewAccountMFAHandler,
		handler.NewSSOHandler,
		handler.NewAdminSSOHandler,
		handler.NewNotificationStreamHandler,
		wire.Bind(new(handler.SessionStarter), new(*middleware.JwtMiddleware)),
