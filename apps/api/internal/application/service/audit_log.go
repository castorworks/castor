...
type AuditLogService interface {
	Gets(ctx context.Context, page, size int, order string, opts ...query.Option) ([]audit_log.AuditLog, int64, error)
...
func (svc *auditLogService) Gets(ctx context.Context, page, size int, order string, opts ...query.Option) ([]audit_log.AuditLog, int64, error) {
	return svc.auditLogRepo.Gets(ctx, page, size, order, opts...)
}
...
func (svc *auditLogService) DeleteBefore(ctx context.Context, before time.Time) (int64, error) {
