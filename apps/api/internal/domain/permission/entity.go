...
var DefaultResources = []Resource{
	...
	{Code: "user:assets:create", Name: "seedResources.user.assets.create", Path: "/api/v1/assets", Actions: StringSlice{ActionPOST}, Category: CategoryUser, Module: "assets", SortOrder: 100, IsSystem: true, IsEnabled: true},
	...
	{Code: "admin:assets:list-by-folder", Name: "seedResources.admin.assets.listByFolder", Path: "/api/v1/admin/assets/folder", Actions: StringSlice{ActionGET}, Category: CategoryAdmin, Module: "assets", SortOrder: 212, IsSystem: true, IsEnabled: true},
	{Code: "admin:assets:list-by-category", Name: "seedResources.admin.assets.listByCategory", Path: "/api/v1/admin/assets/category/:category", Actions: StringSlice{ActionGET}, Category: CategoryAdmin, Module: "assets", SortOrder: 213, IsSystem: true, IsEnabled: true},
	{Code: "admin:assets:list-by-status", Name: "seedResources.admin.assets.listByStatus", Path: "/api/v1/admin/assets/status/:status", Actions: StringSlice{ActionGET}, Category: CategoryAdmin, Module: "assets", SortOrder: 214, IsSystem: true, IsEnabled: true},
...
var DefaultRoles = []Role{
	{Code: RoleAdmin, Name: "seedRoles.admin", Description: "seedRoles.adminDesc", IsSystem: true, IsEnabled: true},
	{Code: RoleAuditor, Name: "seedRoles.auditor", Description: "seedRoles.auditorDesc", IsSystem: true, IsEnabled: true},
	{Code: RoleUser, Name: "seedRoles.user", Description: "seedRoles.userDesc", IsSystem: true, IsEnabled: true},
}
