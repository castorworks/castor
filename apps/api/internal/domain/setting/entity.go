...
var DefaultSettings = []Setting{
	...
	{Key: "security.password.minLength", Value: "8", Type: SettingTypeNumber, Category: CategorySecurity, Name: "seedSettings.minPasswordLength", Description: "seedSettings.minPasswordLengthDesc", DefaultVal: "8", IsSystem: true, IsPublic: false, SortOrder: 20},
