...
func (r *loginHistoryRepository) CountSuccessfulToday(ctx context.Context, opts ...query.Option) (int64, error) {
	var count int64
	q := r.db.WithContext(ctx).Model(&models.LoginHistoryModel{}).Where("success AND created_at >= CURRENT_DATE")
...
func (r *loginHistoryRepository) CountSuccessfulByMonth(ctx context.Context, months int, opts ...query.Option) ([]shared.MonthlyCount, error) {
	return countByMonth(ctx, r.db, "login_histories", "success", months, opts...)
}
