...
var (
	...
	CodeInvalidContactType           = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidContactType}
	CodeContactAlreadyUsed           = ErrCode{Code: ErrCodeAlreadyExists, HTTPStatus: http.StatusConflict, MsgKey: ErrContactAlreadyUsed}
	CodeDeliveryNotConfigured        = ErrCode{Code: ErrCodeDeliveryNotConfigured, HTTPStatus: http.StatusServiceUnavailable, MsgKey: ErrDeliveryChannelNotConfigured}
	...
	CodeSystemDictItemValueLocked    = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrSystemDictItemValueLocked}
	CodeDictItemColorInvalid         = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrDictItemColorInvalid}
	...
	CodeCannotModifySystemRole       = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrCannotModifySystemRole}
	CodeCannotModifySystemResource   = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrCannotModifySystemResource}
	CodeGrantExceedsCaller           = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrGrantExceedsCaller}
	CodeTargetUserExceedsCaller      = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrTargetUserExceedsCaller}
	...
	CodePasswordTooLong              = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrPasswordTooLong}
	CodePasswordTooWeak              = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrPasswordTooWeak}
	CodePasswordUnchanged            = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrPasswordUnchanged}
	CodeCredentialNotExpired         = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrCredentialNotExpired}
	...
	CodeAssetInUse       = ErrCode{Code: ErrCodeAssetInUse, HTTPStatus: http.StatusConflict, MsgKey: ErrAssetInUse}
...
var (
	CodeDepartmentNotFound     = ErrCode{Code: ErrCodeNotFound, HTTPStatus: http.StatusNotFound, MsgKey: ErrDepartmentNotFound}
	CodeInvalidDepartment      = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidDepartment}
	CodeDepartmentConflict     = ErrCode{Code: ErrCodeAlreadyExists, HTTPStatus: http.StatusConflict, MsgKey: ErrDepartmentConflict}
	CodeDepartmentHierarchy    = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrDepartmentHierarchy}
	CodeDepartmentHasChildren  = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrDepartmentHasChildren}
	CodeDepartmentHasMembers   = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrDepartmentHasMembers}
	CodeInvalidDataScope       = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidDataScope}
	CodeDataScopeExceedsCaller = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrDataScopeExceedsCaller}
)

var (
	CodeJobNotFound       = ErrCode{Code: ErrCodeNotFound, HTTPStatus: http.StatusNotFound, MsgKey: ErrJobNotFound}
	CodeInvalidCron       = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidCron}
	CodeJobAlreadyRunning = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrJobAlreadyRunning}
)

var (
	CodeUnsupportedFileFormat = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrUnsupportedFileFormat}
	CodeFileUnreadable        = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrFileUnreadable}
	CodeImportEmpty           = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrImportEmpty}
	CodeImportTooManyRows     = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrImportTooManyRows}
	CodeImportMissingColumn   = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrImportMissingColumn}
	CodeImportInvalidRows     = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrImportInvalidRows}
	CodeExportTooLarge        = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrExportTooLarge}
)

var (
	CodeTOTPRequired        = ErrCode{Code: ErrCodeTOTPRequired, HTTPStatus: http.StatusUnauthorized, MsgKey: ErrTOTPRequired}
	CodeInvalidTOTPCode     = ErrCode{Code: ErrCodeInvalidTOTP, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidTOTPCode}
	CodeMFAChallengeExpired = ErrCode{Code: ErrCodeMFAChallengeExpired, HTTPStatus: http.StatusUnauthorized, MsgKey: ErrMFAChallengeExpired}
	CodeTOTPAlreadyEnabled  = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrTOTPAlreadyEnabled}
	CodeTOTPNotEnabled      = ErrCode{Code: ErrCodeBadRequest, HTTPStatus: http.StatusBadRequest, MsgKey: ErrTOTPNotEnabled}
	CodeTOTPSetupNotStarted = ErrCode{Code: ErrCodeBadRequest, HTTPStatus: http.StatusBadRequest, MsgKey: ErrTOTPSetupNotStarted}
)

var (
	CodeOIDCProviderNotFound = ErrCode{Code: ErrCodeNotFound, HTTPStatus: http.StatusNotFound, MsgKey: ErrOIDCProviderNotFound}
	CodeOIDCProviderConflict = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrOIDCProviderConflict}
	CodeInvalidOIDCProvider  = ErrCode{Code: ErrCodeInvalidInput, HTTPStatus: http.StatusBadRequest, MsgKey: ErrInvalidOIDCProvider}
	CodeOIDCNotConfigured    = ErrCode{Code: ErrCodeBadRequest, HTTPStatus: http.StatusBadRequest, MsgKey: ErrOIDCNotConfigured}
	CodeOIDCDiscoveryFailed  = ErrCode{Code: ErrCodeBadRequest, HTTPStatus: http.StatusBadRequest, MsgKey: ErrOIDCDiscoveryFailed}
	CodeOIDCStateInvalid     = ErrCode{Code: ErrCodeUnauthorized, HTTPStatus: http.StatusUnauthorized, MsgKey: ErrOIDCStateInvalid}
	CodeOIDCAuthFailed       = ErrCode{Code: ErrCodeUnauthorized, HTTPStatus: http.StatusUnauthorized, MsgKey: ErrOIDCAuthFailed}
	CodeOIDCAccountNotLinked = ErrCode{Code: ErrCodeForbidden, HTTPStatus: http.StatusForbidden, MsgKey: ErrOIDCAccountNotLinked}
	CodeOIDCIdentityInUse    = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrOIDCIdentityInUse}
	CodeOIDCLastSignInMethod = ErrCode{Code: ErrCodeConflict, HTTPStatus: http.StatusConflict, MsgKey: ErrOIDCLastSignInMethod}
)
