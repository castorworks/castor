...
const getFileIcon = (fileType: string, fileName: string) => {
  ...
  if (fileType.startsWith('image/'))
    return <Icons.media {...iconProps} className='text-tag-green' />;

  if (fileType === 'application/pdf' || extension === 'pdf')
    return <Icons.fileTypePdf {...iconProps} className='text-tag-red' />;
  ...
  if (
    ...
    return <Icons.fileTypeDoc {...iconProps} className='text-tag-blue' />;
  ...
  if (
    ...
    return <Icons.fileTypeXls {...iconProps} className='text-tag-green' />;
  ...
  if (
    ...
    return <Icons.code {...iconProps} className='text-tag-yellow' />;
  ...
  if (fileType.startsWith('video/') || ['mp4', 'avi', 'mov', 'mkv'].includes(extension))
    return <Icons.video {...iconProps} className='text-tag-purple' />;

  if (fileType.startsWith('audio/') || ['mp3', 'wav', 'ogg'].includes(extension))
    return <Icons.music {...iconProps} className='text-tag-pink' />;
  ...
  if (
    ...
    return <Icons.fileZip {...iconProps} className='text-tag-orange' />;
