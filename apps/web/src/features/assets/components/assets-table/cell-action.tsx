...
export function CellAction({ data }: CellActionProps) {
  ...
  const canDownload = usePermission('/api/v1/admin/assets/download/:objectKey:GET');
  ...
  const statusOptions = [
    { value: 'ACTIVE' as AssetStatus, label: dict.label('asset_status', 'ACTIVE') },
    { value: 'ARCHIVED' as AssetStatus, label: dict.label('asset_status', 'ARCHIVED') }
  ];
  ...
  const downloadUrl = assetUrl(data.objectKey, { admin: true });
