...
import { DEFAULT_ASSET_SCOPE, type Asset, type AssetStatus } from '../../api/types';
...
export function AssetsTable() {
  ...
  const filters = {
    ...
    scope: params.scope || DEFAULT_ASSET_SCOPE,
  ...
  const batchDelete = useMutation({
    ...mergeMutationOptions(batchDeleteAssetsMutation, {
      ...
      // 任意一条被引用时整批拒绝，后端消息说明了原因。
      onError: (error) => {
        toast.error(error.message || t('messages.bulkDeleteFailed'));
      }
    })
  });
