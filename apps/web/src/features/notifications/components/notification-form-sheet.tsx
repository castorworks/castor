...
function getOptions(typeCode: string, fallback: { value: string; label: string }[]) {
...
export function NotificationFormSheet({
  ...
  const typeOptions = getOptions('notification_type', [
  ...
  const levelOptions = getOptions('notification_level', [
